...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'BucketList_userprofile', 'birth_date', self.gf('django.db.models.fields.DateField')())

    def backwards(self, orm):

        # Changing field 'UserProfile.birth_date'
        db.alter_column(u'BucketList_userprofile', 'birth_date', self.gf('django.db.models.fields.DateTimeField')())
    ...
    models = {
        ...
        u'BucketList.userprofile': {
            ...
            'birth_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 10, 18, 0, 0)'}),
