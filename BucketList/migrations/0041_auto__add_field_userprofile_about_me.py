...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'BucketList_userprofile', 'about_me',
                      self.gf('django.db.models.fields.CharField')(default='About Me', max_length=400),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.about_me'
        db.delete_column(u'BucketList_userprofile', 'about_me')
    ...
    models = {
        ...
        u'BucketList.userprofile': {
            ...
            'about_me': ('django.db.models.fields.CharField', [], {'default': "'About Me'", 'max_length': '400'}),
