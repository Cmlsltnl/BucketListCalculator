...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'BucketList_userprofile', 'age', self.gf('django.db.models.fields.DateField')())

    def backwards(self, orm):

        # Changing field 'UserProfile.age'
        db.alter_column(u'BucketList_userprofile', 'age', self.gf('django.db.models.fields.CharField')(max_length=3))
    ...
    models = {
        ...
        u'BucketList.userprofile': {
            ...
            'age': ('django.db.models.fields.DateField', [], {'default': '0'}),
