...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TestingSouth.dances_whenever_able'
        db.add_column(u'BucketList_testingsouth', 'dances_whenever_able',
                      self.gf('django.db.models.fields.BooleanField')(default=0),
                      keep_default=False)

        # Adding field 'TestingSouth.shrubberies'
        db.add_column(u'BucketList_testingsouth', 'shrubberies',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TestingSouth.dances_whenever_able'
        db.delete_column(u'BucketList_testingsouth', 'dances_whenever_able')

        # Deleting field 'TestingSouth.shrubberies'
        db.delete_column(u'BucketList_testingsouth', 'shrubberies')
    ...
    models = {
        ...
        u'BucketList.userprofile': {
            ...
            'savings': ('django.db.models.fields.CharField', [], {'default': '0', 'max_length': '3'}),
