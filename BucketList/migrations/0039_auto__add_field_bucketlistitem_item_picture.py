...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BucketListItem.item_picture'
        db.add_column(u'BucketList_bucketlistitem', 'item_picture',
                      self.gf('django.db.models.fields.files.ImageField')(default='media/static/images/default-item-image.jpg', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BucketListItem.item_picture'
        db.delete_column(u'BucketList_bucketlistitem', 'item_picture')
    ...
    models = {
        u'BucketList.bucketlistitem': {
            ...
            'item_picture': ('django.db.models.fields.files.ImageField', [], {'default': "'media/static/images/default-item-image.jpg'", 'max_length': '100'}),
