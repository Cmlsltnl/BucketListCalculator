...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.retirement'
        db.add_column(u'BucketList_userprofile', 'retirement',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=3),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.retirement'
        db.delete_column(u'BucketList_userprofile', 'retirement')
