...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.savings'
        db.add_column(u'BucketList_userprofile', 'savings',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=3),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.savings'
        db.delete_column(u'BucketList_userprofile', 'savings')
