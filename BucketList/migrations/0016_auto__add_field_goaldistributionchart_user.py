...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GoalDistributionChart.user'
        db.add_column(u'BucketList_goaldistributionchart', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=2, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'GoalDistributionChart.user'
        db.delete_column(u'BucketList_goaldistributionchart', 'user_id')
