...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'BucketList_userprofile', 'birth_date',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2014, 10, 15, 0, 0)),
                      keep_default=False)
    ...
    models = {
        ...
        u'BucketList.userprofile': {
            ...
            'birth_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 10, 15, 0, 0)'}),
