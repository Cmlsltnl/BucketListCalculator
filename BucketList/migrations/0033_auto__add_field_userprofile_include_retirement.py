...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.include_retirement'
        db.add_column(u'BucketList_userprofile', 'include_retirement',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.include_retirement'
        db.delete_column(u'BucketList_userprofile', 'include_retirement')
