...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.retirement_savings'
        db.add_column(u'BucketList_userprofile', 'retirement_savings',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=10),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.retirement_savings'
        db.delete_column(u'BucketList_userprofile', 'retirement_savings')
    ...
    models = {
        ...
        u'BucketList.userprofile': {
            ...
            'retirement': ('django.db.models.fields.CharField', [], {'default': '0', 'max_length': '3'}),
            'retirement_savings': ('django.db.models.fields.CharField', [], {'default': '0', 'max_length': '10'}),
